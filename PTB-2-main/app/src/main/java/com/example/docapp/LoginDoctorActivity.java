...
public class LoginDoctorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSignUpPrompt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(LoginDoctorActivity.this, SignUpDoctorActivity.class);
        ...
        tvForgotPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Navigate to SignUpActivity
                Intent intent = new Intent(LoginDoctorActivity.this, ForgotPasswordEmailActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void performLogin() {
        ...
        if (email.isEmpty() || password.isEmpty()) {
            Toast.makeText(LoginDoctorActivity.this, "Email dan kata sandi harus diisi", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(LoginDoctorActivity.this, "Autentikasi gagal: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }

    private void navigateToHome() {
        Intent intent = new Intent(LoginDoctorActivity.this, HomeDoctorActivity.class);
        startActivity(intent);
        finish();
    }
}
